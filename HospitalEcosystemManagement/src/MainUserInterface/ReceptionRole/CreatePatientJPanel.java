...
public class CreatePatientJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnSignConsentform1 = new javax.swing.JButton();
        lblConcentForm = new javax.swing.JLabel();
        btnSignConcent = new javax.swing.JButton();
        ...
        add(lblPatientFirstName, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 164, -1, -1));

        lblRestaurantInfo.setBackground(new java.awt.Color(255, 255, 255));
        lblRestaurantInfo.setFont(new java.awt.Font("Trebuchet MS", 1, 36)); // NOI18N
        ...
        add(lblRestaurantInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 0, 1394, 82));
        ...
        add(txtFirstName, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 206, 120, -1));
        ...
        add(lblPatientLastName, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 164, -1, -1));
        ...
        add(txtLastName, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 206, 110, -1));
        ...
        add(lblPatientGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(353, 164, -1, -1));
        ...
        lblPatientHealthInsuranceID.setText("HealthInsuranceID");
        add(lblPatientHealthInsuranceID, new org.netbeans.lib.awtextra.AbsoluteConstraints(465, 164, -1, -1));
        ...
        add(txtHealthInsuranceID, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 206, 150, -1));
        ...
        add(lblPatientAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(676, 164, 86, -1));
        ...
        add(txtAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 206, 102, -1));
        ...
        add(lblPatientPhone, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 314, -1, -1));
        ...
        add(txtPhoneNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 354, 150, -1));
        ...
        add(lblDOB, new org.netbeans.lib.awtextra.AbsoluteConstraints(801, 156, -1, 36));

        lblEmail.setBackground(new java.awt.Color(255, 255, 255));
        lblEmail.setFont(new java.awt.Font("Trebuchet MS", 1, 18)); // NOI18N
        lblEmail.setText("Email");
        add(lblEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 314, -1, -1));
        ...
        add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 354, 130, -1));
        ...
        add(lblAddress4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1043, 164, 116, -1));
        ...
        add(txtInjuryType, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 344, 180, -1));
        ...
        add(lblPhoneNumber4, new org.netbeans.lib.awtextra.AbsoluteConstraints(434, 306, -1, -1));

        lblRestaurantName4.setBackground(new java.awt.Color(255, 255, 255));
        lblRestaurantName4.setFont(new java.awt.Font("Georgia", 1, 18)); // NOI18N
        lblRestaurantName4.setText("UserName");
        add(lblRestaurantName4, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 470, -1, -1));
        ...
        add(txtUserName, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 470, 150, -1));
        ...
        add(btnSubmit, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 680, 159, 46));

        lblRestaurantName5.setBackground(new java.awt.Color(255, 255, 255));
        lblRestaurantName5.setFont(new java.awt.Font("Georgia", 1, 18)); // NOI18N
        lblRestaurantName5.setText("Password");
        add(lblRestaurantName5, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 520, -1, -1));
        ...
        add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 520, 150, -1));

        jRadioCash.setBackground(new java.awt.Color(255, 255, 255));
        jRadioCash.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        ...
        add(jRadioCash, new org.netbeans.lib.awtextra.AbsoluteConstraints(879, 305, -1, -1));

        jRadioInsurance.setBackground(new java.awt.Color(255, 255, 255));
        jRadioInsurance.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        ...
        add(jRadioInsurance, new org.netbeans.lib.awtextra.AbsoluteConstraints(1034, 305, -1, -1));

        btnBrowse.setFont(new java.awt.Font("Trebuchet MS", 1, 11)); // NOI18N
        ...
        add(btnBrowse, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 455, -1, -1));
        add(lblPhotoImage, new org.netbeans.lib.awtextra.AbsoluteConstraints(142, 418, 105, 111));

        btnSignConsentform1.setBackground(new java.awt.Color(15, 85, 177));
        btnSignConsentform1.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        btnSignConsentform1.setForeground(new java.awt.Color(255, 255, 255));
        btnSignConsentform1.setText("Display Consent Form");
        btnSignConsentform1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSignConsentform1ActionPerformed(evt);
            }
        });
        add(btnSignConsentform1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 540, -1, 36));
        add(lblConcentForm, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 582, 336, 181));

        btnSignConcent.setBackground(new java.awt.Color(15, 85, 177));
        btnSignConcent.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        btnSignConcent.setForeground(new java.awt.Color(255, 255, 255));
        btnSignConcent.setText("Sign Consent Form");
        btnSignConcent.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSignConcentActionPerformed(evt);
            }
        });
        add(btnSignConcent, new org.netbeans.lib.awtextra.AbsoluteConstraints(374, 582, 168, 39));
        ...
        add(txtDOB, new org.netbeans.lib.awtextra.AbsoluteConstraints(792, 206, 160, -1));
        ...
        add(lblPaymentMethod, new org.netbeans.lib.awtextra.AbsoluteConstraints(848, 259, -1, -1));
        ...
        add(GenderComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 206, 92, -1));
        ...
        add(BloodGroupComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(1009, 206, 150, -1));
        ...
        add(lblAccidentLocation, new org.netbeans.lib.awtextra.AbsoluteConstraints(652, 304, -1, 25));
        ...
        add(txtAccidentLocation, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 344, 150, -1));

        lblPhoto.setBackground(new java.awt.Color(255, 255, 255));
        lblPhoto.setFont(new java.awt.Font("Trebuchet MS", 1, 18)); // NOI18N
        lblPhoto.setText("Photo");
        add(lblPhoto, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 416, -1, -1));
        ...
        add(lblErrorHId, new org.netbeans.lib.awtextra.AbsoluteConstraints(499, 232, 124, 21));
        ...
        add(lblErrorInjury, new org.netbeans.lib.awtextra.AbsoluteConstraints(455, 370, 87, 22));
        ...
        jLabel1.setText("Accident  Information");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(459, 256, 292, 34));

        jLabel2.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel2.setText("Personal  Information");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 103, 531, 31));

        jLabel3.setFont(new java.awt.Font("Trebuchet MS", 1, 24)); // NOI18N
        jLabel3.setText("Contact  Information");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(38, 259, 301, 31));
        ...
        add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 296, 1434, 8));
        ...
        add(btnSubmit1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 680, 159, 46));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/ReceptionRole/create-patient.gif"))); // NOI18N
        jLabel4.setText("jLabel4");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 400, 391, 307));
    ...
    private void btnSignConsentform1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignConsentform1ActionPerformed
        // TODO add your handling code here:
        //ImageIcon ii = new ImageIcon("/Users/ronitchougule/Pictures/Concent Form.png");
        ImageIcon ii = new ImageIcon("src/MainFrame/Photos/Concent Form.png");

        Image image = ii.getImage().getScaledInstance(380, 180, Image.SCALE_SMOOTH);
        lblConcentForm.setIcon(new ImageIcon(image));
    }//GEN-LAST:event_btnSignConsentform1ActionPerformed

    private void btnSignConcentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignConcentActionPerformed
        // TODO add your handling code here:
        ImageIcon ii = new ImageIcon("src/MainFrame/Photos/ConcentNewSign.png");
        Image image = ii.getImage().getScaledInstance(380, 180, Image.SCALE_SMOOTH);
        lblConcentForm.setIcon(new ImageIcon(image));
        JOptionPane.showMessageDialog(null, "Concent Form Signed");
        IsconcentFormSigned = true;
    }//GEN-LAST:event_btnSignConcentActionPerformed
    ...
    private javax.swing.JButton btnSignConcent;
    private javax.swing.JButton btnSignConsentform1;
    ...
    private javax.swing.JLabel lblConcentForm;
